...
import (
	...
	vesselProto "github.com/nitinjaiswal/go-micro-grpc-2/src/vessel-service/proto/vessel"
...
func main() {
	...
	srv := micro.NewService(
		micro.Name("docker.service.consignment"),
	)

	srv.Init()

	vesselClient := vesselProto.NewVesselServiceClient("docker.service.vessel", srv.Client())
